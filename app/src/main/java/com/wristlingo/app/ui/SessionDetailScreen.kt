...
private fun UtteranceRow(utt: UtteranceEntity) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = "${utt.srcLang ?: "?"}: ${utt.srcText}", style = MaterialTheme.typography.bodyMedium)
        Text(text = "${utt.dstLang}: ${utt.dstText}", style = MaterialTheme.typography.bodyLarge, fontWeight = FontWeight.SemiBold)
    }
}
